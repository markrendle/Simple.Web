    ...
    public class DataContractXmlContentTypeHandlerTests
    {
        ...
        public void PicksUpOrdersLinkFromCustomer()
        {
            ...
            const string expected =
                ...
                "          xmlns:i='http://www.w3.org/2001/XMLSchema-instance'>" + "  <Id>42</Id>" + "  <Orders i:nil='true' />" +
        ...
        public void SerializesOrder()
        {
            ...
            const string expected =
                ...
                "       xmlns:i='http://www.w3.org/2001/XMLSchema-instance'>" + "  <CustomerId>42</CustomerId>" + "  <Id>54</Id>" +
                "  <link href='/order/54' rel='self' type='application/vnd.order+xml' xmlns='' />" + "</Order>";
