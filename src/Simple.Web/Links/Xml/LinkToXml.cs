...
namespace Simple.Web.Links.Xml
{
	public class LinkToXml : IConvertXmlFor<Link>
	{
		public static readonly LinkToXml Instance = new LinkToXml();

		public Link FromXml(XElement element)
		{
			// come back to this when necessary
			throw new System.NotImplementedException();
		}

		public Link FromXml(XElement element, Link loadThis)
		{
			// come back to this when necessary
			throw new System.NotImplementedException();
		}

		public XElement ToXml(Link value, XName name = null)
		{
	...
	public static class CourseToXmlExtensions
	{
