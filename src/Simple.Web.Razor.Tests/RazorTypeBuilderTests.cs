namespace Simple.Web.Razor.Tests
{
    ...
    {
        private const string HandlerTemplateText = @"@handler Simple.Web.Razor.Tests.TestHandler
<!DOCTYPE html><html><body>@Handler.Text</body></html>";

        private const string ModelTemplateText = @"@model Simple.Web.Razor.Tests.TestModel
