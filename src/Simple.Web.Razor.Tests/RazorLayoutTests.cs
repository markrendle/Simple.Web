...
@{
    Layout = ""~/Views/Layouts/SimpleLayout.cshtml"";
            ...
            const string Expected =
                @"<!DOCTYPE html><html><head><title>Simple Layout Page</title></head><body><p>Test Text</p></body></html>";
...
@{
    ...
    ViewBag.Title = ""Custom Layout Title"";
            ...
            const string Expected =
                @"<!DOCTYPE html><html><head><title>Custom Layout Title</title></head><body><p>Test Text</p></body></html>";
