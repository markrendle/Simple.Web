namespace Simple.Web.Razor.Tests
{
    ...
    {
        private readonly string ExamplePathPrefix = String.Format("{0}{1}temp{1}example",
                                                                  Path.DirectorySeparatorChar.ToString() != @"\" ? String.Empty : "C:",
        ...
        {
            Assert.Equal(ExamplePathPrefix,
                         RazorViews.AssemblyAppRoot(String.Format("{0}{1}bin{1}Debug{1}me.dll",
                                                                  ExamplePathPrefix,
                                                                  Path.DirectorySeparatorChar)));
        }
        ...
        {
            Assert.Equal(ExamplePathPrefix,
                         RazorViews.AssemblyAppRoot(String.Format("{0}{1}bin{1}me.dll", ExamplePathPrefix, Path.DirectorySeparatorChar)));
        }
        ...
        {
            Assert.Equal(ExamplePathPrefix,
                         RazorViews.AssemblyAppRoot(String.Format("{0}{1}bin{1}Release{1}me.dll",
                                                                  ExamplePathPrefix,
                                                                  Path.DirectorySeparatorChar)));
        }
        ...
        {
            Assert.Equal(ExamplePathPrefix,
                         RazorViews.AssemblyAppRoot(String.Format("{0}{1}me.dll", ExamplePathPrefix, Path.DirectorySeparatorChar)));
        }
