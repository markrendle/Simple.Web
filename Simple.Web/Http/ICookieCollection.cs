namespace Simple.Web.Http
{
    ...
    public interface ICookieCollection
    {
        ...
        /// </summary>
        /// <returns>
        /// The <see cref="T:Simple.Web.Http.ICookie"/> specified by <paramref name="index"/>.
        /// </returns>
        ...
        /// <summary>
        /// Returns the <see cref="T:Simple.Web.Http.ICookie"/> item with the specified index from the cookie collection.
        /// </summary>
        /// <returns>
        /// The <see cref="T:Simple.Web.Http.ICookie"/> specified by <paramref name="index"/>.
        /// </returns>
        ...
        /// </summary>
        /// <param name="cookie">The <see cref="T:Simple.Web.Http.ICookie"/> object to update. </param>
        ...
        /// </summary>
        /// <param name="cookie">The <see cref="T:Simple.Web.Http.ICookie"/> to add to the collection. </param>
